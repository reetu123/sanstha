...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<?php
		...
		<div id="pmpro_pricing_fields" class="pmpro_checkout">
			<h3>
				...
				<?php if(count($pmpro_levels) > 1) { ?><span class="pmpro_checkout-h3-msg"><a href="<?php echo site_url(),'/pricing/'; ?>"><?php _e('change', 'paid-memberships-pro' );?></a></span><?php } ?>
			</h3>
	...
	<div id="pmpro_user_fields" class="pmpro_checkout">
		...
		<h3>
			...
			<span class="pmpro_checkout-h3-msg"><?php _e('Already have an account?', 'paid-memberships-pro' );?> <a href="<?php echo site_url().'/login/'; ?>"><?php _e('Log in here', 'paid-memberships-pro' );?></a></span>
		</h3>
		<div class="pmpro_checkout-fields">
...
<!--
	...
	jQuery('.pmpro_checkout-field').find('label').append('<span class="pmpro_asterisk"> <abbr title="Required Field">*</abbr></span>');
