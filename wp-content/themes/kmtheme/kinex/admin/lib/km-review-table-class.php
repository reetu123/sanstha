...
class KM_Review_Tables extends WP_List_Table
{
    ...
    public function prepare_items() {
        ...
        $query = "SELECT * FROM {$wpdb->prefix}review_raiting";

        $query .= (isset($_GET['s']) AND !empty($_GET['s'])) ?  ' where `review_description` like "%'
            .$wpdb->_real_escape($_GET['s']).'%"  or `rating` like "%'.$wpdb->_real_escape($_GET['s']).'%"':' ';
    ...
    public function column_action($item){
        ...
        return $this->row_actions(
            array(
                'view' => '<a  class="btn btn-success" href="' . KM_REVIEW_URL . '?page=km-review-management&action=view&id=' . $item['id'] . '">
View</a>',
                'delete' => '<a  class="btn btn-danger" href="' . KM_REVIEW_URL . '?page=km-review-management&action=delete&id=' . $item['id'] . '">
Delete</a>',
            ),true);
    }
