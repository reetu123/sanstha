<div class='asp_select_label asp_select_single'>
    <select aria-label="<?php echo asp_icl_t('Taxonomy select [' . $taxonomy . "] ($real_id)", 'Taxonomy select for ' . $taxonomy, true) ?>"
            class='asp_gochosen'
            multiple
            data-placeholder="<?php echo !empty($filter->_display_mode['box_placeholder_text']) ?
                        asp_icl_t("Multiselect placeholder [".$taxonomy."]" . " ($real_id)", $filter->data['box_placeholder_text']) : ''; ?>"
