...
if ( !function_exists('asp_parse_filters') ) {
    function asp_parse_filters( $id, $o, $clear = false ) {
        ...
        asp_parse_custom_field_filters($o);
...
if ( !function_exists("asp_parse_custom_field_filters") ) {
    function asp_parse_custom_field_filters($o) {
        global $wpdb;
        ...
        foreach ($f as $k => $v) {
            ...
            $data = array(
                ...
                "title" => w_isset_def($bfield->asp_f_show_title, 'asp_checked') == 'asp_checked' ? $bfield->asp_f_title : '',
            ...
            $filter = wd_asp()->front_filters->create(
                'custom_field',
                asp_icl_t('[CF Filter Label] ' . $bfield->asp_f_title, $bfield->asp_f_title),
                $bfield->asp_f_type,
                $data
            );
